...
class TestFilters(unittest.TestCase):
    ...
    def test_should_ignore_by_name(self):
        ...
        self.assertTrue(should_ignore("test_file.py", "path/to/test_file.py", ignore_names, ignore_paths))
        self.assertTrue(should_ignore("__pycache__.py", "path/to/__pycache__.py", ignore_names, ignore_paths))
        self.assertFalse(should_ignore("main.py", "path/to/main.py", ignore_names, ignore_paths))
    ...
    def test_should_ignore_by_path(self):
        ...
        self.assertTrue(should_ignore("file.py", "path/tests/file.py", ignore_names, ignore_paths))
        self.assertTrue(should_ignore("file.py", "path/build/file.py", ignore_names, ignore_paths))
        self.assertFalse(should_ignore("file.py", "path/src/file.py", ignore_names, ignore_paths))
    ...
    def test_should_ignore_combined(self):
        ...
        self.assertTrue(should_ignore("test_file.py", "path/src/test_file.py", ignore_names, ignore_paths))
        self.assertTrue(should_ignore("file.py", "path/build/file.py", ignore_names, ignore_paths))
        self.assertFalse(should_ignore("file.py", "path/src/file.py", ignore_names, ignore_paths))
